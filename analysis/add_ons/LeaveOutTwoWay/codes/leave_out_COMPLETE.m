function [sigma2_psi,sigma_psi_alpha,sigma2_alpha,SE_sigma2_psi,SE_sigma_psi_alpha,SE_sigma2_alpha] = leave_out_COMPLETE(y,id,firmid,leave_out_level,year,controls,resid_controls,andrews_estimates,eigen_diagno,subsample_llr_fit,restrict_movers,do_SE, type_of_algorithm,epsilon,filename)
...
out=[y,firmid,id,firmid_old,id_old,Pii,fe,pe];
s=[filename '_FE.csv'];
dlmwrite(s, out, 'delimiter', '\t', 'precision', 16); 
end
