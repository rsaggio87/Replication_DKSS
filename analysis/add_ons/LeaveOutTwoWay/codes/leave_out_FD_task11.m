function [C_SHARE_1 C_SHARE_2 C_SHARE_3 C_SHARE_4 tau_share] = leave_out_FD_task11(y,id,firmid,leave_out_level,leave_2_out,controls,type_algorithm,eigen_diagno,eigen_fast,do_montecarlo,restrict_movers,filename)
...
s=[filename '_FD_LEAVE2'];
save(s)	
%load(s)	
disp('time to brute force C')
toc
[TAU TOTAL SUBTRACT_CO_MOVERS SUBTRACT_BAD SUBTRACT_GOOD SUM_CO_MOVERS SUM_BAD SUM_GOOD C_SHARE_1 C_SHARE_2 C_SHARE_3 C_SHARE_4]=paths_network(firmid,id,id_movers,firmid_delta,firmid_delta_f,ydelta,eta_h,Pii,L,pfun_,Fdelta,I_Lambda_P,L_P,Lambda_B,F,C);
...
tau_share = (TAU-BAD_ESTIMATOR1)/TAU	
