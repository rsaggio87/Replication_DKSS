function [theta, V, COV_R1, gamma_sq,Fstatistic,b_1,theta_1,FIRST]= leave_out_estimation_two_way_pls(type_quadratic_form,y,J,N,X,xx,Lchol,bias_part,eta_h,I_Lambda_P,L_P,Lambda_B,W_to_use,my_first_part,sigma_predict,x1bar,lambda_1)
...
theta=bias_part-(1/NT)*eta_h'*Lambda_B*eta_h;
