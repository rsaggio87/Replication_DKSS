...
if do_SE == 1
    ...
    if DO_R1 == 0
    [V, FIRST] = hutchison_trace_SE_task8(sigma_i,cluster,type_random,DO_R1,X,xx,Lchol,Lambda_B,I_Lambda_P,L_P,type_quadratic_form,K,N,J,sigma_predict,W_to_use);
    end
    
    if DO_R1 == 1
    [V,FIRST,aux_SIM2] = hutchison_trace_SE_task8(sigma_i,cluster,type_random,DO_R1,X,xx,Lchol,Lambda_B,I_Lambda_P,L_P,type_quadratic_form,K,N,J,sigma_predict,W_to_use);
    end
