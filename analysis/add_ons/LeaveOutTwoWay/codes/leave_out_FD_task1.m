...
A_b=F'*(fe-mean(fe));
[W_to_use, my_first_part] = construc_W_FD(ydelta,Fdelta,L,pfun_,A_b,Lambda_B,I_Lambda_P,L_P,eta_h);
[sigma2_psi_s, V_exact_s, ~, COV_R1, gamma_sq,~,b_1,theta_1]= leave_out_estimation_two_way_FD_task1(ydelta,Fdelta,F,L,pfun_,sigma_2_psi_AKM,Lambda_B,Lambda_P,I_Lambda_P,L_P,eta_h,W_to_use,my_first_part,x1bar,lambda_1);   
