function [theta, V, sigma_predict, COV_R1, gamma_sq,Fstatistic,b_1,theta_1]= leave_out_estimation_two_way_FD_task1(ydelta,Fdelta,F,L,pfun_,bias_part,Lambda_B,Lambda_P,I_Lambda_P,L_P,eta_h,W_to_use,my_first_part,x1bar,lambda_1)
